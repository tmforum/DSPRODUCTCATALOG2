 ...
 *
 */
public class ResourceSpecificationId implements Serializable {
    ...
    public ResourceSpecificationId() {
    }

    public ResourceSpecificationId(String catalogId, Float catalogVersion, String id, Float version) {
    ...
    public boolean equals(Object object) {
        ...
        final ResourceSpecificationId other = (ResourceSpecificationId) object;
