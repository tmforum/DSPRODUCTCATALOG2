...
public class ProductSpecificationInCatalogIdVersionFacadeREST extends AbstractFacadeREST {
    ...
    public Response create(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") String catalogVersion, ProductSpecification input, @Context UriInfo uriInfo) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response update(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") String catalogVersion, @PathParam("entityId") String entityId, ProductSpecification input, @Context UriInfo uriInfo) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response update(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") String catalogVersion, @PathParam("entityId") String entityId, @PathParam("entityVersion") String entityVersion, ProductSpecification input, @Context UriInfo uriInfo) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") String catalogVersion, @PathParam("entityId") String entityId, ProductSpecification input, @Context UriInfo uriInfo) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") String catalogVersion, @PathParam("entityId") String entityId, @PathParam("entityVersion") String entityVersion, ProductSpecification input, @Context UriInfo uriInfo) {
