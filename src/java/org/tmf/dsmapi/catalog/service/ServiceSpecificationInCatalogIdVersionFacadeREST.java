...
public class ServiceSpecificationInCatalogIdVersionFacadeREST {
    ...
    public Response create(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") Float catalogVersion, ServiceSpecification input, @Context UriInfo uriInfo) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response update(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") Float catalogVersion, @PathParam("entityId") String entityId, ServiceSpecification input, @Context UriInfo uriInfo) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response update(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") Float catalogVersion, @PathParam("entityId") String entityId, @PathParam("entityVersion") Float entityVersion, ServiceSpecification input, @Context UriInfo uriInfo) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") Float catalogVersion, @PathParam("entityId") String entityId, ServiceSpecification input, @Context UriInfo uriInfo) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("catalogId") String catalogId, @PathParam("catalogVersion") Float catalogVersion, @PathParam("entityId") String entityId, @PathParam("entityVersion") Float entityVersion, ServiceSpecification input, @Context UriInfo uriInfo) {
